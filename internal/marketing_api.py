...
@nacosClient.customRequestClient(method="POST", url="/ebike_marketing/riding_config/platform/favorable_card", )  # TODO
def favorable_card_info(jsonData):
    pass


@nacosClient.customRequestClient(method="POST", url="/ebike_marketing/riding_config/platform/favorable_card", )
