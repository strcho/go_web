...
class UpdateDepositDeserializer(ReqBaseDeserializer):
    ...
    pin = fields.String(required=True, description="用户标识")
    deposited_mount = fields.Integer(required=False, load_default=ARG_DEFAULT, description="押金金额*100")
    deposited_stats = fields.Integer(required=False, load_default=ARG_DEFAULT, description="押金状态 1缴纳  2 退还  3 冻结")
...
# class UpdateDepositedDeserializer(ReqBaseDeserializer):
#     """
#     更新用户押金信息
#     """
#
